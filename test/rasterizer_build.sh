...
verilator -Wno-fatal --cc ../rasterizer_unit.sv  rasterizer_test.cpp ../vga_unit_modules.sv  --exe -I../ -CFLAGS -g -LDFLAGS -lsdl2 -LDFLAGS -L/opt/X11/lib -LDFLAGS -lX11 -LDFLAGS -ljpeg \
